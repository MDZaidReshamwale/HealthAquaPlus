package com.synchronoss.water_reminder.fragements
...
import com.synchronoss.water_reminder.MainActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        etNotificationText.editText!!.setText(
            sharedPref.getString(
                ...
                "Hey... It's time to  drink some water.... Let's stay hydrated"
            )
        )
