...
//    onstart of the app while user perform operations
...
//        selecting the intakes water level
        ...
        op50ml.setOnClickListener {
            ...
            selectedOption = 50
            Toast.makeText(applicationContext,"You have selected $selectedOption",Toast.LENGTH_SHORT).show()
