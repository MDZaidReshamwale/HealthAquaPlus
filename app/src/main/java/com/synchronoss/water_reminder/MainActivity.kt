...
import com.synchronoss.water_reminder.fragements.BottomSheetFragment
import com.synchronoss.water_reminder.helper.AlarmHelper
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onStart() {
            ...
            if (selectedOption != null) {
                if ((inTook * 100 / totalIntake) <= 140) {
                    if (sqliteHelper.addIntook(dateNow, selectedOption!!) > 0) {
                        ...
                        Snackbar.make(it, "Hooray you consumed ${inTook}", Snackbar.LENGTH_SHORT)
                            .show()

                    }
                } else {
                    Snackbar.make(it, "You already achieved the goal.. Hydrated :)", Snackbar.LENGTH_SHORT).show()
                }
                selectedOption = null
        ...
        op50ml.setOnClickListener {
            ...
            selectedOption = 50
            Toast.makeText(applicationContext,"Stay hydrated by consuming $selectedOption ml ",Toast.LENGTH_SHORT).show()
